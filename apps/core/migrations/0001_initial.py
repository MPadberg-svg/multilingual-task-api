    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["slug", "is_active"], name="core_organi_slug_8e2e45_idx"
                    ),
                    models.Index(
                        fields=["plan", "is_active"], name="core_organi_plan_84edef_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    ...
                    models.Index(
                        fields=["user", "role"], name="core_organi_user_id_6230c8_idx"
                    ),
                ],
